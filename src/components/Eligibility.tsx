      ...
      <div className="section-container">
        <div className="max-w-3xl mx-auto text-center mb-16 reveal-animation">
          ...
          <p className="text-lg text-gray-600">
            The UIY competition is exclusively open to engineering
            undergraduates from specific universities in Sri Lanka, providing
            them with a platform to showcase their innovative solutions.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="reveal-animation">
            ...
            <div
              className="mt-8 bg-white rounded-xl p-8 shadow-lg reveal-animation"
              style={{ animationDelay: '0.2s' }}
            >
              <h3 className="text-2xl font-semibold mb-4">Group Consistency</h3>
              <p className="text-gray-600 mb-4">
                UIY inventors can participate in group projects with a maximum
                of 6 members per group.
              </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600">
                    Students must be registered undergraduates at one of the
                    eligible universities and hold IESL student membership.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-uiy-blue flex-shrink-0 mt-0.5" />
                      <span>
                        Declaration letter from the head of department
                      </span>
                    </li>
                  </ul>
                </div>
