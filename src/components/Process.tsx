    ...
    <section id="process" className="py-24 bg-white">
      <div className="section-container">
        <div className="max-w-3xl mx-auto text-center mb-16 reveal-animation">
          <p className="text-sm font-semibold text-uiy-blue uppercase tracking-wider mb-3">Competition Journey</p>
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">Path to UIY</h2>
          <p className="text-lg text-gray-600">
            From application to awards, follow the structured process to showcase your engineering innovation.
          </p>
        </div>
          ...
          {timelineData.map((item, index) => (
            ...
            >
              ...
              <div className={`md:w-5/12 ${index % 2 === 0 ? 'md:text-right md:pr-16' : 'md:pl-16'}`}>
                <div className={`bg-white p-6 rounded-xl shadow-md border-l-4 ${item.highlight ? 'border-l-uiy-accent' : 'border-l-uiy-blue'}`}>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 md:p-12 shadow-sm reveal-animation">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-3xl font-display font-bold mb-8 text-center">Evaluation Process</h3>
            ...
            <div className="mb-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm min-h-[300px]">
                {activeTab === 0 ? (
                      ...
                      {evaluationCriteria.map((criterion, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <div className="w-6 h-6 rounded-full bg-uiy-blue/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <span className="text-uiy-blue font-medium text-sm">{index + 1}</span>
                          </div>
                  ...
                  <div className="animate-fade-in">
                    <p className="text-gray-700 mb-6">
                      Applications may be unsuccessful for the following reasons:
                    </p>
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start gap-3">
                        <span className="text-red-500">•</span>
                        <p>Innovation uses dangerous or unsafe materials and conditions</p>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-red-500">•</span>
                        <p>Innovation that can cause harm to humans and animals</p>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-red-500">•</span>
                      ...
                      <li className="flex items-start gap-3">
                        <span className="text-red-500">•</span>
                        <p>Products/models that contain/use live specimens without ethical clearance</p>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-red-500">•</span>
